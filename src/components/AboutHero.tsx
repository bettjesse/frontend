    ...
    return (
      <>
        ...
        <div className="hidden md:flex w-full items-center justify-center relative">
          ...
          <div className="absolute top-1/2 transform -translate-y-1/2 md:left-6 md:w-1/3 w-4/5 max-w-xl">
            <div className="bg-[#30120B] bg-opacity-75 p-4 md:p-8 relative rounded-lg">
              ...
              <h1 className="text-2xl md:text-3xl mt-4 text-[#FFBA00] font-bold">
              Bancassurance
              </h1>
            </div>
          </div>
